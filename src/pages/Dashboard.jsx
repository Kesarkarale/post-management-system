  ...
  right:-150
      ...
      <div style={s.wrap}>
        <section style={s.hero}>
          ...
          <h1 style={s.h1}>Hello, {user?.name || "User"}</h1>
          <p style={s.text}>
            Welcome to your professional post management system. Manage posts,
            authors, tags and content activity from one clean dashboard.
          </p>
        </section>
        ...
        <section style={s.stats}>
          ...
          <div style={s.card}>
            <div style={s.icon}>⚡</div>
            <h3 style={s.num}>{latest ? "Active" : "Empty"}</h3>
        ...
        <section style={s.grid}>
          <div style={s.panel}>
            ...
            <Link style={s.action} to="/posts/new">➕ Create New Post</Link>
            <Link style={s.action} to="/posts">📚 Manage Posts</Link>
            <Link style={s.action} to="/posts">🔎 Search Content</Link>
          </div>
          ...
          <div style={s.panel}>
            ...
            {latest ? (
              <>
                <h3 style={{ color: "#f8fafc" }}>{latest.title}</h3>
                <p style={s.text}>{latest.content.slice(0, 150)}...</p>
                <Link style={s.primary} to={`/posts/${latest.id}`}>
                  View Latest Post
                </Link>
              </>
            ) : (
              <p style={s.text}>No posts available yet. Create your first post.</p>
            )}
          </div>
          ...
          <div style={s.panel}>
            ...
            <div style={s.activity}>
              <div style={s.activityItem}>✅ Dashboard opened successfully</div>
              <div style={s.activityItem}>📚 Posts loaded from localStorage</div>
              <div style={s.activityItem}>🔐 User authenticated</div>
              <div style={s.activityItem}>🚀 Project ready for deployment</div>
            </div>
          </div>
